...
const FilterRepoted = ({setItems, data}) => {
          ...
          <div className="bg-white rounded-lg relative  lg:w-[850px]  lg:h-[600px] md:w-[750px] md:h-[550px] w-full h-full">
            ...
            <div>
              ...
              Submit
                ...
                <div className="mt-5">
                  <p className="text-[13px] w-[117px] font-semibold bg-[#0077B5] text-white py-1 px-[17px] rounded rounded-[20px]">
                    Job Industry
                  </p>
