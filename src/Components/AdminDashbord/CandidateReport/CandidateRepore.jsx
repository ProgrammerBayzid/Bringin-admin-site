...
const CandidateRepore = () => {
  const [repotedCandidate, setRepotedCandidate] = useState([]);
  const [isLoding, setIsLoding] = useState(false);

  useEffect(() => {
    fetch("http://rsapp.bringin.io/candidate_report")
      .then((res) => res.json())
      .then((data) => {
        setIsLoding(true);
  ...
  const handelSort = () => {
    let _industry = [...repotedCandidate];
                      ...
                      >
                        <tr className="border-b dark:border-neutral-500">
                          ...
                          <td className="whitespace-nowrap px-6 py-4 font-medium">
                            <div>
                                {
                                    candi?.candidateid?.image? 
                                    <img className="w-16" src={candi.candidateid.image} /> : <p>Null</p>
                                }
                            </div>
                          </td>
                          <td className="whitespace-nowrap px-6 py-4 font-medium">
...
export default CandidateRepore;
