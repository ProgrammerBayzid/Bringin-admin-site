...
const FilterRejectRecruter = ({setItems, data}) => {
  ...
  return (
    <div>
      <div>
        <input type="checkbox" id="rejectprofile-modal" className="modal-toggle" />
          ...
          <div className="bg-white rounded-lg relative  lg:w-[850px]  lg:h-[600px] md:w-[750px] md:h-[550px] w-full h-full">
            ...
            <div>
              ...
              Submit
                ...
                <div className="mt-5">
                  <p className="text-[13px] w-[117px] font-semibold bg-[#0077B5] text-white py-1 px-[15px] rounded rounded-[20px]">
                    Job Industry
                  </p>
                      ...
                      <button
                        ...
                        className={
                          isActiveIndustry == ind?.industryname
                            ? "border border-[1px] text-[13px] m-1.5 bg-[#0077B5] text-white rouunded rounded-[30px] px-2"
                            : "border border-[1px] text-[13px] m-1.5 hover:bg-[#0077B5] hover:text-white rouunded rounded-[30px] px-2"
                        }
                      >
                        {ind?.industryname}
                      </button>
...
export default FilterRejectRecruter;
