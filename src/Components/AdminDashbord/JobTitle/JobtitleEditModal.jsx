...
const JobtitleEditModal = ({ title, message, add, closeModal, modalData,  }) => {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    return (
        <div>
        <div >
         <input type="checkbox" id="jobtitle-modal" className="modal-toggle" />
             ...
             <form onSubmit={handleSubmit(add)}>
               <div className="form-control w-full ">
                 <label className="label">
                   {" "}
                   <span className="label-text">Edit Job Title</span>
                 </label>
                 <input
                   type="text"
