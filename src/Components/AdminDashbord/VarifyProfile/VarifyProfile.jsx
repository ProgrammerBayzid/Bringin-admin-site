...
const VarifyProfile = () => {
  ...
  useEffect(() => {
    fetch("https://rsapp.bringin.io/profile_verifys?profile_verify_type=1")
      .then((res) => res.json())
      .then((data) => {
        setIsLoding(true);
  ...
  const makeVerifide = (_id) => {
    try {
      fetch(`https://rsapp.bringin.io/unverifyRecruterProfile/${_id}`, {
        method: "PATCH",
      })
        .then((res) => res.json())
        .then((data) => {
                ...
                <table className="w-full text-left ">
                  <thead className="border-b font-medium bg-[#005784] ">
                    <tr>
                      ...
                      <th
                        scope="col"
                        className="pl-2 w-[70px] text-[14px] text-white ml-3 font-medium py-3 border-r-[1px] border-white"
                      >
                        <img src={pro} />
                      </th>
                      <th
                      ...
                      <tbody key={i}>
                        <tr className="">
                          ...
                          <div className="flex gap-1">
                            <button    onClick={() => makeVerifide(pre._id)} className="border px-3 py-2 rounded rounded-[30px]">
                            Cancel Approve
                            </button>
